                ...
                <div className="flex gap-y-6 flex-wrap">
                    <div className="flex w-full gap-x-4 items-center">
                        ...
                        <div className="relative">
                            <p className="font-semibold text-xl w-full mb-1">{user.name}</p>
                            <div className="text-[12px] p-0.5 inline-block rounded-md bg-gradient-to-tr from-primary to-secondary">
                                <button className="px-2 rounded-md font-semibold bg-white">FREE</button>
                            </div>
                        </div>
                    </div>
                    <div className="bg-gray-400/20 rounded-xl px-8 py-8 w-full flex gap-y-4 flex-wrap">
                    ...
                    <div className="w-full flex justify-center">
                        <Link
                            href={"/logout"}
                            className="bg-gray-400/20 rounded-xl px-6 py-3 inline-block hover:bg-gray-400/40 duration-150"
                        >
                            Logout
                        </Link>
                    </div>
